...
export default function PhoneFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-1/2 -translate-x-1/2 md:hidden z-50 flex items-center justify-center gap-3 bg-[var(--blue-france-main)] text-white font-bold px-6 py-4 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.3)] animate-[bounce_2s_infinite] w-[90%] max-w-[320px] transition-transform active:scale-95 border-2 border-white/20"
    ...
    >
      ...
      <span className="text-lg">01 84 17 32 18</span>
    </a>
  );
}
