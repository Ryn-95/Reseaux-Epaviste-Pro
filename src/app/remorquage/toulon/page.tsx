...
export const metadata: Metadata = {
  title: 'Service de Remorquage Toulon 24h/24 – Transport Automobile Certifié',
  description: 'Service de remorquage professionnel à Toulon. Transport sécurisé toutes distances pour véhicules légers, utilitaires et deux-roues. Intervention rapide 7j/7.',
  alternates: {
    canonical: 'https://reseauepaviste.fr/remorquage/toulon/',
  },
};
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'AutoRepair',
      '@id': 'https://reseauepaviste.fr/remorquage/toulon/#business',
      name: 'RéseauEpaviste Toulon',
      description: 'Direction des Interventions Routières - Service de remorquage certifié à Toulon',
      url: 'https://reseauepaviste.fr/remorquage/toulon/',
...
export default function RemorquageToulonPage() {
  return (
    <>
          ...
          <div className="fr-header__body py-6 flex items-center justify-between border-b-2 border-[var(--blue-france-main)]">
            ...
            <div className="hidden lg:flex flex-col items-end">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-bold uppercase text-gray-500 tracking-widest">Remorquage Toulon actif</span>
              </div>
      ...
      <main id="content">
        <HeroSection
          ...
          title="Service de Remorquage Agréé à Toulon"
          subtitle="Solution logistique certifiée pour le transport de votre véhicule depuis ou vers Toulon. Intervention immédiate par plateau technique spécialisé, disponible 24h/24."
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative group overflow-hidden shadow-2xl border-4 border-white">
                <Image 
                  ...
                  alt="Remorquage véhicule à Toulon"
                  fill
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm p-4 border-l-4 border-[var(--blue-france-main)] shadow-lg max-w-xs">
                  <p className="text-[10px] font-bold text-[var(--blue-france-main)] uppercase mb-1">Logistique Toulon</p>
              ...
              <div className="space-y-8">
                <div className="fr-alert">
                  <p className="text-sm font-bold leading-relaxed">
                    Normes de sécurité : Tous nos convois de remorquage à Toulon respectent strictement le Code de la Route et les consignes de sécurité routière.
                  </p>
                </div>
                <h2 className="text-4xl font-black uppercase leading-[1.1] m-0 border-none p-0">Une logistique de pointe à Toulon</h2>
                <p className="text-lg text-[var(--grey-600)] leading-relaxed">
                  Notre flotte de dépanneuses-plateaux intervient sur l\'ensemble du secteur de <strong>Toulon</strong> pour assurer le transfert de vos véhicules immobilisés. Nous garantissons une prise en charge délicate, adaptée aux spécificités techniques de chaque modèle, y compris les véhicules de prestige et les deux-roues.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              <div className="lg:col-span-5 space-y-8">
                ...
                <p className="text-[var(--grey-600)] leading-relaxed text-lg">
                  Besoin de déplacer un véhicule depuis Toulon ? Nos régulateurs calculent immédiatement le coût de votre transfert sur simple appel.
                </p>
                <div className="p-8 bg-[var(--blue-france-950)] border-l-8 border-[var(--blue-france-main)] shadow-sm">
                  <p className="text-[10px] font-black uppercase text-[var(--blue-france-main)] tracking-[0.2em] mb-3">Ligne Transfert Toulon</p>
        ...
        <FAQSection items={[
          { question: 'Quel est le prix au kilomètre à Toulon ?', answer: 'Nos tarifs sont calculés sur une base forfaitaire incluant la prise en charge et la distance. Contactez-nous pour une cotation précise en fonction de votre point de départ à Toulon.' },
          { question: 'Remorquez-vous les utilitaires à Toulon ?', answer: 'Oui, nous disposons de plateaux haute capacité capables de remorquer des véhicules utilitaires jusqu\'à 3.5 tonnes (fourgons, bennes, etc.) sur le secteur de Toulon.' },
        ...
        ]} title="Questions fréquentes - Remorquage Toulon" />
      </main>
    </>
  );
}