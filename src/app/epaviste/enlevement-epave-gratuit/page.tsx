...
export const metadata: Metadata = {
  title: 'ENLEVEMENT EPAVE GRATUIT | Réseaux Épaviste',
  description: 'Découvrez notre service de enlevement epave gratuit avec Réseaux Épaviste. Intervention rapide et agréée.',
};

export default function enlevementepavegratuitPage() {
  return (
    <>
      <Breadcrumbs items={[
        { label: 'Accueil', href: '/' },
        { label: 'epaviste', href: '/epaviste' },
        { label: 'enlevement epave gratuit', href: '/epaviste/enlevement-epave-gratuit' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        badge="Service Spécialisé"
        title="ENLEVEMENT EPAVE GRATUIT"
        subtitle="Nous vous accompagnons dans toutes vos démarches pour enlevement epave gratuit."
