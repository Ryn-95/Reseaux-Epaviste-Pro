...
export const metadata: Metadata = {
  title: 'PRIME CONVERSION 2026 | Réseaux Épaviste',
  description: 'Découvrez notre service de prime conversion 2026 avec Réseaux Épaviste. Intervention rapide et agréée.',
};

export default function primeconversion2026Page() {
  return (
    <>
      <Breadcrumbs items={[
        { label: 'Accueil', href: '/' },
        { label: 'epaviste', href: '/epaviste' },
        { label: 'prime conversion 2026', href: '/epaviste/prime-conversion-2026' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        badge="Service Spécialisé"
        title="PRIME CONVERSION 2026"
        subtitle="Nous vous accompagnons dans toutes vos démarches pour prime conversion 2026."
