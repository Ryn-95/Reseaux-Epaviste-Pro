...
export const metadata: Metadata = {
  title: 'Service d\'Enlèvement de VHU Asnières-sur-Seine (92) – Épaviste Agréé',
  description: 'Demande de prise en charge pour l\'enlèvement de véhicule hors d\'usage (VHU) à Asnières-sur-Seine et dans le département Hauts-de-Seine. Certificat de destruction CERFA remis immédiatement. Service public de proximité.',
  alternates: {
    canonical: 'https://reseauepaviste.fr/epaviste/asnieres-sur-seine/',
  },
};
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'AutoRepair',
      '@id': 'https://reseauepaviste.fr/epaviste/asnieres-sur-seine/#business',
      name: 'RéseauEpaviste Asnières-sur-Seine',
      description: 'Centre d\'appel pour l\'enlèvement de VHU certifié à Asnières-sur-Seine',
      url: 'https://reseauepaviste.fr/epaviste/asnieres-sur-seine/',
      telephone: '+33-1-84-17-32-18',
      areaServed: { '@type': 'City', name: 'Asnières-sur-Seine' },
      address: {
        '@type': 'PostalAddress',
...
export default function EpavisteAsniressurSeinePage() {
  return (
    <>
      ...
      <main id="content">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative group overflow-hidden shadow-2xl border-4 border-white">
                <Image 
                  ...
                  alt="Enlèvement d'épave à Asnières-sur-Seine"
                  fill
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm p-4 border-l-4 border-[var(--blue-france-main)] shadow-lg max-w-xs">
                  ...
                  <p className="text-sm font-bold text-[var(--grey-900)]">Intervention rapide à Asnières-sur-Seine et communes limitrophes.</p>
                </div>
              </div>
              <div className="space-y-8">
                <div className="fr-alert">
                  <p className="text-sm font-bold leading-relaxed">
                    Tout propriétaire de véhicule hors d\'usage à Asnières-sur-Seine est responsable de sa remise à un centre VHU agréé, sous peine de sanctions administratives.
                  </p>
                </div>
                <h2 className="text-4xl font-black uppercase leading-[1.1] m-0 border-none p-0">Votre épaviste de proximité à Asnières-sur-Seine</h2>
                <p className="text-lg text-[var(--grey-600)] leading-relaxed">
                  Nos unités d\'intervention couvrent l\'intégralité de la commune de <strong>Asnières-sur-Seine</strong> (92) pour collecter vos véhicules destinés à la destruction. Nous assurons la dépollution systématique et le recyclage des matériaux dans le strict respect des directives environnementales.
                </p>
              </div>
            </div>
          </div>
        ...
        <FAQSection items={[
          { question: 'L\'enlèvement est-il réellement gratuit à Asnières-sur-Seine ?', answer: 'Oui, l\'intervention est sans frais si le véhicule est complet (présence du bloc moteur et du pot catalytique). Nos frais sont couverts par la revente des matériaux recyclables.' },
          { question: 'Quels sont les délais d\'intervention en Hauts-de-Seine ?', answer: 'Nous intervenons généralement sous 24h à Asnières-sur-Seine et dans les villes voisines comme Colombes, Gennevilliers, Clichy.' },
        ...
        ]} title="Informations complémentaires Asnières-sur-Seine" />
      </main>
    </>
  );
}
