...
export const metadata = buildPageMetadata({
  ...
  description:
    "Épaviste agréé dans le Val-d’Oise : enlèvement d’épave (VHU) pris en charge, centres VHU partenaires et certificat de destruction officiel. Demandez un rappel ou appelez 01 84 17 32 18.",
