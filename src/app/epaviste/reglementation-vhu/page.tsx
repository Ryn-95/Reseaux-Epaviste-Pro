...
export const metadata: Metadata = {
  title: 'REGLEMENTATION VHU | Réseaux Épaviste',
  description: 'Découvrez notre service de reglementation vhu avec Réseaux Épaviste. Intervention rapide et agréée.',
};

export default function reglementationvhuPage() {
  return (
    <>
      <Breadcrumbs items={[
        { label: 'Accueil', href: '/' },
        { label: 'epaviste', href: '/epaviste' },
        { label: 'reglementation vhu', href: '/epaviste/reglementation-vhu' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        badge="Service Spécialisé"
        title="REGLEMENTATION VHU"
        subtitle="Nous vous accompagnons dans toutes vos démarches pour reglementation vhu."
