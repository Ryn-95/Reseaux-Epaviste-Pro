...
export const metadata: Metadata = {
  title: 'VOITURE ACCIDENTEE | Réseaux Épaviste',
  description: 'Découvrez notre service de voiture accidentee avec Réseaux Épaviste. Intervention rapide et agréée.',
};

export default function voitureaccidenteePage() {
  return (
    <>
      <Breadcrumbs items={[
        { label: 'Accueil', href: '/' },
        { label: 'epaviste', href: '/epaviste' },
        { label: 'voiture accidentee', href: '/epaviste/voiture-accidentee' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        ...
        subtitle="Nous vous accompagnons dans toutes vos démarches pour voiture accidentee."
