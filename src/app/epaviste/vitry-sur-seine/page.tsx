...
export const metadata: Metadata = {
  title: 'Service d\'Enlèvement de VHU Vitry-sur-Seine (94) – Épaviste Agréé',
  description: 'Demande de prise en charge pour l\'enlèvement de véhicule hors d\'usage (VHU) à Vitry-sur-Seine et dans le département Val-de-Marne. Certificat de destruction CERFA remis immédiatement. Service public de proximité.',
  alternates: {
    canonical: 'https://reseauepaviste.fr/epaviste/vitry-sur-seine/',
  },
};
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'AutoRepair',
      '@id': 'https://reseauepaviste.fr/epaviste/vitry-sur-seine/#business',
      name: 'RéseauEpaviste Vitry-sur-Seine',
      description: 'Centre d\'appel pour l\'enlèvement de VHU certifié à Vitry-sur-Seine',
      url: 'https://reseauepaviste.fr/epaviste/vitry-sur-seine/',
      telephone: '+33-1-84-17-32-18',
      areaServed: { '@type': 'City', name: 'Vitry-sur-Seine' },
      address: {
        '@type': 'PostalAddress',
...
export default function EpavisteVitrysurSeinePage() {
  return (
    <>
          ...
          <div className="fr-header__body py-6 flex items-center justify-between border-b-2 border-[var(--blue-france-main)]">
            ...
            <div className="hidden lg:flex flex-col items-end">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-bold uppercase text-gray-500 tracking-widest">Secteur Vitry-sur-Seine Actif</span>
              </div>
      ...
      <main id="content">
        <HeroSection
          ...
          title="Épaviste Agréé à Vitry-sur-Seine (94)"
          subtitle="Service public de proximité pour l'enlèvement gratuit de vos véhicules hors d'usage. Mise en conformité administrative totale sur Vitry-sur-Seine et ses environs."
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative group overflow-hidden shadow-2xl border-4 border-white">
                <Image 
                  ...
                  alt="Enlèvement d'épave à Vitry-sur-Seine"
                  fill
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm p-4 border-l-4 border-[var(--blue-france-main)] shadow-lg max-w-xs">
                  ...
                  <p className="text-sm font-bold text-[var(--grey-900)]">Intervention rapide à Vitry-sur-Seine et communes limitrophes.</p>
                </div>
              </div>
              <div className="space-y-8">
                <div className="fr-alert">
                  <p className="text-sm font-bold leading-relaxed">
                    Tout propriétaire de véhicule hors d\'usage à Vitry-sur-Seine est responsable de sa remise à un centre VHU agréé, sous peine de sanctions administratives.
                  </p>
                </div>
                <h2 className="text-4xl font-black uppercase leading-[1.1] m-0 border-none p-0">Votre épaviste de proximité à Vitry-sur-Seine</h2>
                <p className="text-lg text-[var(--grey-600)] leading-relaxed">
                  Nos unités d\'intervention couvrent l\'intégralité de la commune de <strong>Vitry-sur-Seine</strong> (94) pour collecter vos véhicules destinés à la destruction. Nous assurons la dépollution systématique et le recyclage des matériaux dans le strict respect des directives environnementales.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              <div className="lg:col-span-5 space-y-8">
                ...
                <div className="p-8 bg-[var(--blue-france-950)] border-l-8 border-[var(--blue-france-main)] shadow-sm">
                  <p className="text-[10px] font-black uppercase text-[var(--blue-france-main)] tracking-[0.2em] mb-3">Ligne Directe Vitry-sur-Seine</p>
        ...
        <FAQSection items={[
          { question: 'L\'enlèvement est-il réellement gratuit à Vitry-sur-Seine ?', answer: 'Oui, l\'intervention est sans frais si le véhicule est complet (présence du bloc moteur et du pot catalytique). Nos frais sont couverts par la revente des matériaux recyclables.' },
          { question: 'Quels sont les délais d\'intervention en Val-de-Marne ?', answer: 'Nous intervenons généralement sous 24h à Vitry-sur-Seine et dans les villes voisines comme Ivry-sur-Seine, Villejuif, Choisy-le-Roi.' },
        ...
        ]} title="Informations complémentaires Vitry-sur-Seine" />
      </main>
    </>
  );
}
