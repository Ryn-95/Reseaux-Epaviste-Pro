...
export const metadata: Metadata = {
  title: 'PANNE BATTERIE | Réseaux Épaviste',
  description: 'Découvrez notre service de panne batterie avec Réseaux Épaviste. Intervention rapide et agréée.',
};

export default function pannebatteriePage() {
  return (
    <>
      <Breadcrumbs items={[
        { label: 'Accueil', href: '/' },
        { label: 'depannage auto', href: '/depannage-auto' },
        { label: 'panne batterie', href: '/depannage-auto/panne-batterie' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        badge="Service Spécialisé"
        title="PANNE BATTERIE"
        subtitle="Nous vous accompagnons dans toutes vos démarches pour panne batterie."
