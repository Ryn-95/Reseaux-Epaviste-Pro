...
export const metadata: Metadata = {
  title: 'REMORQUAGE | Réseaux Épaviste',
  description: 'Découvrez notre service de remorquage avec Réseaux Épaviste. Intervention rapide et agréée.',
};
  ...
  return (
    <>
      <Breadcrumbs items={[
        ...
        { label: 'remorquage', href: '/depannage-auto/remorquage' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        ...
        title="REMORQUAGE"
        subtitle="Nous vous accompagnons dans toutes vos démarches pour remorquage."
