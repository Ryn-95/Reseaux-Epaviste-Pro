...
export const metadata: Metadata = {
  title: 'Assistance Routière Courbevoie 24h/24 – Dépannage Technique Certifié',
  description: 'Service d\'assistance automobile à Courbevoie. Intervention technique 24h/24 pour batterie, pneumatiques et pannes mécaniques. Service certifié disponible 7j/7.',
  alternates: {
    canonical: 'https://reseauepaviste.fr/depannage-auto/courbevoie/',
  },
};
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'AutoRepair',
      '@id': 'https://reseauepaviste.fr/depannage-auto/courbevoie/#business',
      name: 'RéseauEpaviste Courbevoie',
      description: 'Direction des Opérations Techniques - Service de dépannage automobile certifié à Courbevoie',
      url: 'https://reseauepaviste.fr/depannage-auto/courbevoie/',
...
export default function DepannageAutoCourbevoiePage() {
  return (
    <>
      ...
      <main id="content">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative group overflow-hidden shadow-2xl border-4 border-white">
                <Image 
                  ...
                  alt="Dépannage automobile à Courbevoie"
                  fill
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm p-4 border-l-4 border-[var(--blue-france-main)] shadow-lg max-w-xs">
                  <p className="text-[10px] font-bold text-[var(--blue-france-main)] uppercase mb-1">Expertise Courbevoie</p>
              ...
              <div className="space-y-8">
                <div className="fr-alert">
                  <p className="text-sm font-bold leading-relaxed">
                    Sécurisation : En cas de panne à Courbevoie, allumez vos feux de détresse et revêtez votre gilet de haute visibilité avant notre arrivée.
                  </p>
                </div>
                <h2 className="text-4xl font-black uppercase leading-[1.1] m-0 border-none p-0">Assistance technique certifiée à Courbevoie</h2>
                <p className="text-lg text-[var(--grey-600)] leading-relaxed">
                  Nos unités mobiles d\'intervention sont équipées des derniers outils de diagnostic pour résoudre vos pannes directement sur site à <strong>Courbevoie</strong>. Nous intervenons sur tout type de véhicule (thermique, hybride, électrique) avec des techniciens habilités par la Direction des Opérations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              <div className="lg:col-span-5 space-y-8">
                ...
                <p className="text-[var(--grey-600)] leading-relaxed text-lg">
                  Nos dépanneurs sont en astreinte permanente sur le secteur de Courbevoie. Laissez vos coordonnées pour un rappel et une estimation précise du délai d\'arrivée.
                </p>
        ...
        <FAQSection items={[
          { question: 'Quel est le coût d\'un dépannage à Courbevoie ?', answer: 'Nos tarifs sont conventionnés et dépendent de la nature de l\'intervention. Un devis transparent vous est communiqué avant tout acte technique.' },
          { question: 'Intervenez-vous les jours fériés à Courbevoie ?', answer: 'Oui, nous assurons une continuité de service 365 jours par an, 24h sur 24, y compris les dimanches et jours fériés sur Courbevoie.' },
          { question: 'Proposez-vous le remorquage si la réparation est impossible ?', answer: 'Absolument. Si votre véhicule ne peut être réparé sur place à Courbevoie, nous organisons son transfert vers le garage de votre choix ou notre centre technique.' }
        ]} title="Questions fréquentes - Dépannage Courbevoie" />
      </main>
    </>
  );
}