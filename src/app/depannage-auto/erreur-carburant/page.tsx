...
export const metadata: Metadata = {
  title: 'ERREUR CARBURANT | Réseaux Épaviste',
  description: 'Découvrez notre service de erreur carburant avec Réseaux Épaviste. Intervention rapide et agréée.',
};

export default function erreurcarburantPage() {
  return (
    <>
      <Breadcrumbs items={[
        { label: 'Accueil', href: '/' },
        { label: 'depannage auto', href: '/depannage-auto' },
        { label: 'erreur carburant', href: '/depannage-auto/erreur-carburant' }
      ]} />
      <main id="content">
      <HeroSection
        variant="local"
        badge="Service Spécialisé"
        title="ERREUR CARBURANT"
        subtitle="Nous vous accompagnons dans toutes vos démarches pour erreur carburant."
